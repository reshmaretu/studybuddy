...
export default function ChumRenderer({
    ...
    const rawBaseColorId = baseColorIdOverride !== undefined ? (baseColorIdOverride || 'base7') : (activeBaseColor || 'base7');
    const baseColorId = rawBaseColorId.trim() === "" ? 'base7' : rawBaseColorId;
