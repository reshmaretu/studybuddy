    ...
    return (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-3 sm:p-4 overflow-y-auto custom-scrollbar">
            ...
            >
                ...
                {/* LEFT PANEL: Task Selection (DND & Tap) */}
                <div className="w-full md:w-1/3 bg-[var(--bg-dark)] border border-[var(--border-color)] rounded-2xl p-4 sm:p-5 flex flex-col h-auto md:h-full min-h-0 mb-4 md:mb-0 md:mr-6 shrink-0 shadow-inner">
                    ...
                    <DndContext sensors={sensors} onDragStart={handleDragStart} onDragEnd={handleDragEnd}>
                        {/* Scrollable Area */}
                        <div className="flex-1 overflow-y-visible md:overflow-y-auto pr-2 space-y-3 custom-scrollbar min-h-0 mb-4 md:mb-0">
                        ...
                        <div className="mt-4 pt-4 border-t border-[var(--border-color)] flex-shrink-0 hidden md:block">
                            <CrucibleDropZone />
                        </div>
                        <DragOverlay>
                            {(() => {
                ...
                <div className="flex-1 flex flex-col justify-between h-auto md:h-full overflow-y-visible md:overflow-y-auto custom-scrollbar md:pr-2">
                            ...
                            <div className="flex items-center justify-between p-4 rounded-2xl border border-[var(--border-color)] bg-[var(--bg-dark)]/50">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-[var font-bold text-sm">{pomodoroFocus} / {pomodoroShortBreak} / {pomodoroLongBreak}</p>
                                    </div>
                                </div>
                                <SquishyButton
                    ...
                    {/* Launch Buttons - Combined FlowState and StudyCafe sessions into a unified launch button */}
                    <div className="mt-auto pt-4 border-t border-[var(--border-color)]">
                        <SquishyButton
                            ...
                            className="w-full flex items-center justify-center gap-3 p-4 rounded-2xl border border-[var(--accent-teal)]/30 bg-[var(--accent-teal)]/10 hover:bg-[var(--accent-teal)] hover:text-[#050808] hover:border-[var(--accent-teal)] transition-all group shadow-[0_0_15px_rgba(20,184,166,0.1)] hover:shadow-[0_0_20px_rgba(20,184,166,0.3)]"
                        >
                            <Coffee size={24} className="text-[var(--accent-teal)] group-hover:text-[#050808] transition-colors" />
                            <span className="font-bold text-lg text-[var(--text-main)] group-hover:text-[#050808] transition-colors">Start Focus Session</span>
                        </SquishyButton>
                    </div>
                </div>
